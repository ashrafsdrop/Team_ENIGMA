    ...
    <div className="p-6 space-y-6">
      <Card className="bg-gradient-to-r from-[#6c5ce7]/10 to-[#00d4aa]/10 border-[#6c5ce7]/20">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs text-[#8888aa] uppercase tracking-wider">Truck ID</p>
            <p className="text-2xl font-bold text-[#e8e8f0]">{stats.truckId}</p>
            <p className="text-sm text-[#8888aa]">{stats.driver}</p>
          </div>
          <div className="text-right">
            <Badge variant={stats.status === "moving" ? "success" : "default"} className="text-sm px-3 py-1">
              {stats.status}
            </Badge>
            <p className="text-xs text-[#8888aa] mt-1">ETA: {stats.eta}</p>
          </div>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <div className="p-4 bg-[#0a0a0f] rounded-lg border border-[#1a1a2e]">
            ...
            <button className="w-full mt-4 bg-[#00d4aa] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#00d4aa]/80 transition-colors">
              Start Trip
            </button>
          </div>
        </Card>

...
from .views import ItemViewSet, ItemImageViewSet, AIAnalysisView, RegisterView, CustomTokenObtainPairView, WasteCollectionRequestViewSet, WasteTypeViewSet, STSViewSet, VanViewSet, DumpRequestViewSet, NotificationViewSet, WasteTransferViewSet, TruckViewSet, LandfillViewSet, AreaViewSet, UserViewSet
